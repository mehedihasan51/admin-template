...
<div class="container">
    ...
    <div class="card">
      {{-- <div class="profile-cover">
        <button class="btn btn-light btn-sm">Edit Cover Photo</button>
      </div> --}}
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('update.Password') }}">
              ...
              <div class="mb-3">
                ...
                <input type="password"  class="form-control  @error('old_password') is-invalid @enderror" id="currentPassword" name="old_password" >
              </div>
              <div class="mb-3">
